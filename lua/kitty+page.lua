return function(INPUT_LINE_NUMBER, CURSOR_LINE, CURSOR_COLUMN, SCROLLBACK)
  vim.print("kitty sent:", INPUT_LINE_NUMBER, CURSOR_LINE, CURSOR_COLUMN, vim.api.nvim_buf_line_count(0))
